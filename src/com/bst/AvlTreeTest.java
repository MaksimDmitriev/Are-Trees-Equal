...
public class AvlTreeTest {
    ...
    public void testSingleRotateLeft() {
        AvlTree t1 = new AvlTree(10);
        t1.insert(14, 56);
        Assert.assertEquals(t1.mRoot, 14);
        Assert.assertEquals(t1.mRoot.mLeft, 10);
        Assert.assertEquals(t1.mRoot.mRight, 56);
    }
    ...
    public void testSingleRotateRight() {
        AvlTree t1 = new AvlTree(10);
        t1.insert(2, 1);
        Assert.assertEquals(t1.mRoot, 2);
        Assert.assertEquals(t1.mRoot.mLeft, 1);
        Assert.assertEquals(t1.mRoot.mRight, 10);
    }
}
